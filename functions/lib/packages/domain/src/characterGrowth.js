...
exports.CHARACTER_GROWTH_DEFINITIONS = void 0;
exports.getGrowthNode = getGrowthNode;
exports.isGrowthNodeAutoUnlocked = isGrowthNodeAutoUnlocked;
exports.canUnlockGrowthNode = canUnlockGrowthNode;
exports.buildUnlockedSetWithAuto = buildUnlockedSetWithAuto;
exports.CHARACTER_GROWTH_DEFINITIONS = {
    'shirogami-yuu': {
...
function getGrowthNode(characterId, nodeId) {
    return exports.CHARACTER_GROWTH_DEFINITIONS[characterId]?.[nodeId];
}
function isGrowthNodeAutoUnlocked(characterId, nodeId) {
    return getGrowthNode(characterId, nodeId)?.autoUnlock ?? false;
}
function canUnlockGrowthNode(characterId, nodeId, unlockedNodes) {
...
function buildUnlockedSetWithAuto(characterId, unlockedNodes) {
    const set = new Set(unlockedNodes);
    const definition = exports.CHARACTER_GROWTH_DEFINITIONS[characterId];
    if (definition) {
